...
\dataavailability{The NANOGrav 15-year data set and public free-spectrum KDE products analyzed in this study are publicly available from the NANOGrav Collaboration. The reproducibility package for this manuscript has been prepared for release as \path{nanohertz-gwb-model-comparison-repro}; the final GitHub URL and Zenodo DOI must be inserted here before journal submission. The local package contains the scripts, priors, seeds, output JSON files and figure-generation commands used for all tables and figures in this manuscript.}
