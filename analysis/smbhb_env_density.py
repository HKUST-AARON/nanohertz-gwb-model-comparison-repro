...
SAMPLES_PATH = REPO_ROOT / "analysis_outputs" / "smbhb_unified" / "smbhb_sbpl" / "posterior_equal_samples.npz"
OUTPUT_DIR = REPO_ROOT / "analysis_outputs" / "smbhb_unified"
...
def main() -> None:
    ...
    if "param_names" in data:
        ...
        try:
            fb_index = param_names.index("gw_log10_fbend")
        except ValueError as exc:
            raise RuntimeError("gw_log10_fbend not found in posterior samples") from exc
    else:
        fb_index = 1
